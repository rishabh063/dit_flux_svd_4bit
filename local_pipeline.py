...
from local_utils import calculate_shift , retrieve_timesteps 

from mask_latent import prepare_mask_latents
from local_text_encoder import encode_prompt
from latent_util import _prepare_latent_image_ids , _pack_latents , _unpack_latents , prepare_latents
...
class FluxFillPipeline(
    ...
    def __call__(
        ...
        if output_type == "latent":
            ...
            latents = _unpack_latents(latents, height, width, self.vae_scale_factor)
